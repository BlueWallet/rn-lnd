...
export namespace lnrpc {
    ...
    interface IChannelAcceptRequest {
        ...
        maxValueInFlight?: (Long|null);

        /** ChannelAcceptRequest channelReserve */
        channelReserve?: (Long|null);
    ...
    class ChannelAcceptRequest implements IChannelAcceptRequest {
        ...
        /** ChannelAcceptRequest fundingAmt. */
        public fundingAmt: Long;

        /** ChannelAcceptRequest pushAmt. */
        public pushAmt: Long;

        /** ChannelAcceptRequest dustLimit. */
        public dustLimit: Long;

        /** ChannelAcceptRequest maxValueInFlight. */
        public maxValueInFlight: Long;

        /** ChannelAcceptRequest channelReserve. */
        public channelReserve: Long;

        /** ChannelAcceptRequest minHtlc. */
        public minHtlc: Long;

        /** ChannelAcceptRequest feePerKw. */
        public feePerKw: Long;
    ...
    interface IChannelAcceptResponse {
        ...
        reserveSat?: (Long|null);

        /** ChannelAcceptResponse inFlightMaxMsat */
        inFlightMaxMsat?: (Long|null);
    ...
    class ChannelAcceptResponse implements IChannelAcceptResponse {
        ...
        /** ChannelAcceptResponse reserveSat. */
        public reserveSat: Long;

        /** ChannelAcceptResponse inFlightMaxMsat. */
        public inFlightMaxMsat: Long;

        /** ChannelAcceptResponse maxHtlcCount. */
        public maxHtlcCount: number;

        /** ChannelAcceptResponse minHtlcIn. */
        public minHtlcIn: Long;
    ...
    interface IHTLC {
        ...
        forwardingChannel?: (Long|null);

        /** HTLC forwardingHtlcIndex */
        forwardingHtlcIndex?: (Long|null);
    }
    ...
    class HTLC implements IHTLC {
        ...
        /** HTLC htlcIndex. */
        public htlcIndex: Long;

        /** HTLC forwardingChannel. */
        public forwardingChannel: Long;

        /** HTLC forwardingHtlcIndex. */
        public forwardingHtlcIndex: Long;
    ...
    class ChannelConstraints implements IChannelConstraints {
        ...
        /** ChannelConstraints chanReserveSat. */
        public chanReserveSat: Long;

        /** ChannelConstraints dustLimitSat. */
        public dustLimitSat: Long;

        /** ChannelConstraints maxPendingAmtMsat. */
        public maxPendingAmtMsat: Long;

        /** ChannelConstraints minHtlcMsat. */
        public minHtlcMsat: Long;
    ...
    interface IChannel {
        ...
        localBalance?: (Long|null);

        /** Channel remoteBalance */
        remoteBalance?: (Long|null);

        /** Channel commitFee */
        commitFee?: (Long|null);

        /** Channel commitWeight */
        commitWeight?: (Long|null);

        /** Channel feePerKw */
        feePerKw?: (Long|null);

        /** Channel unsettledBalance */
        unsettledBalance?: (Long|null);

        /** Channel totalSatoshisSent */
        totalSatoshisSent?: (Long|null);

        /** Channel totalSatoshisReceived */
        totalSatoshisReceived?: (Long|null);

        /** Channel numUpdates */
        numUpdates?: (Long|null);
        ...
        localChanReserveSat?: (Long|null);

        /** Channel remoteChanReserveSat */
        remoteChanReserveSat?: (Long|null);
    ...
    class Channel implements IChannel {
        ...
        /** Channel localBalance. */
        public localBalance: Long;

        /** Channel remoteBalance. */
        public remoteBalance: Long;

        /** Channel commitFee. */
        public commitFee: Long;

        /** Channel commitWeight. */
        public commitWeight: Long;

        /** Channel feePerKw. */
        public feePerKw: Long;

        /** Channel unsettledBalance. */
        public unsettledBalance: Long;

        /** Channel totalSatoshisSent. */
        public totalSatoshisSent: Long;

        /** Channel totalSatoshisReceived. */
        public totalSatoshisReceived: Long;

        /** Channel numUpdates. */
        public numUpdates: Long;
        ...
        /** Channel localChanReserveSat. */
        public localChanReserveSat: Long;

        /** Channel remoteChanReserveSat. */
        public remoteChanReserveSat: Long;
    ...
    interface IChannelCloseSummary {
        ...
        settledBalance?: (Long|null);

        /** ChannelCloseSummary timeLockedBalance */
        timeLockedBalance?: (Long|null);
    ...
    class ChannelCloseSummary implements IChannelCloseSummary {
        ...
        /** ChannelCloseSummary settledBalance. */
        public settledBalance: Long;

        /** ChannelCloseSummary timeLockedBalance. */
        public timeLockedBalance: Long;
    ...
    class GetInfoResponse implements IGetInfoResponse {
        ...
        /** GetInfoResponse bestHeaderTimestamp. */
        public bestHeaderTimestamp: Long;
    ...
    interface IOpenChannelRequest {
        ...
        remoteMaxValueInFlightMsat?: (Long|null);
    ...
    class OpenChannelRequest implements IOpenChannelRequest {
        ...
        /** OpenChannelRequest localFundingAmount. */
        public localFundingAmount: Long;
        ...
        /** OpenChannelRequest remoteMaxValueInFlightMsat. */
        public remoteMaxValueInFlightMsat: Long;
    ...
    namespace PendingChannelsResponse {
        ...
        interface ICommitments {
            ...
            localCommitFeeSat?: (Long|null);

            /** Commitments remoteCommitFeeSat */
            remoteCommitFeeSat?: (Long|null);

            /** Commitments remotePendingCommitFeeSat */
            remotePendingCommitFeeSat?: (Long|null);
        }
        ...
        class Commitments implements ICommitments {
            ...
            /** Commitments localCommitFeeSat. */
            public localCommitFeeSat: Long;

            /** Commitments remoteCommitFeeSat. */
            public remoteCommitFeeSat: Long;

            /** Commitments remotePendingCommitFeeSat. */
            public remotePendingCommitFeeSat: Long;
    ...
    interface IWalletBalanceResponse {
        ...
        confirmedBalance?: (Long|null);

        /** WalletBalanceResponse unconfirmedBalance */
        unconfirmedBalance?: (Long|null);
    }
    ...
    class WalletBalanceResponse implements IWalletBalanceResponse {
        ...
        /** WalletBalanceResponse confirmedBalance. */
        public confirmedBalance: Long;

        /** WalletBalanceResponse unconfirmedBalance. */
        public unconfirmedBalance: Long;
    ...
    class ChannelBalanceResponse implements IChannelBalanceResponse {
        ...
        /** ChannelBalanceResponse pendingOpenBalance. */
        public pendingOpenBalance: Long;
    ...
    class Hop implements IHop {
        ...
        /** Hop chanCapacity. */
        public chanCapacity: Long;

        /** Hop amtToForward. */
        public amtToForward: Long;
    ...
    class Route implements IRoute {
        ...
        /** Route totalAmt. */
        public totalAmt: Long;

        /** Route hops. */
        public hops: lnrpc.IHop[];

        /** Route totalFeesMsat. */
        public totalFeesMsat: Long;
    ...
    class RoutingPolicy implements IRoutingPolicy {
        ...
        /** RoutingPolicy feeBaseMsat. */
        public feeBaseMsat: Long;

        /** RoutingPolicy feeRateMilliMsat. */
        public feeRateMilliMsat: Long;

        /** RoutingPolicy disabled. */
        public disabled: boolean;

        /** RoutingPolicy maxHtlcMsat. */
        public maxHtlcMsat: Long;
    ...
    class NetworkInfo implements INetworkInfo {
        ...
        /** NetworkInfo totalNetworkCapacity. */
        public totalNetworkCapacity: Long;

        /** NetworkInfo avgChannelSize. */
        public avgChannelSize: number;

        /** NetworkInfo minChannelSize. */
        public minChannelSize: Long;

        /** NetworkInfo maxChannelSize. */
        public maxChannelSize: Long;

        /** NetworkInfo medianChannelSizeSat. */
        public medianChannelSizeSat: Long;

        /** NetworkInfo numZombieChans. */
        public numZombieChans: Long;
    ...
    interface IInvoice {
        ...
        /** Invoice settleIndex */
        settleIndex?: (Long|null);

        /** Invoice amtPaid */
        amtPaid?: (Long|null);

        /** Invoice amtPaidSat */
        amtPaidSat?: (Long|null);

        /** Invoice amtPaidMsat */
        amtPaidMsat?: (Long|null);
    ...
    class Invoice implements IInvoice {
        ...
        /** Invoice addIndex. */
        public addIndex: Long;

        /** Invoice settleIndex. */
        public settleIndex: Long;

        /** Invoice amtPaid. */
        public amtPaid: Long;

        /** Invoice amtPaidSat. */
        public amtPaidSat: Long;

        /** Invoice amtPaidMsat. */
        public amtPaidMsat: Long;
    ...
    interface IInvoiceHTLC {
        ...
        acceptTime?: (Long|null);

        /** InvoiceHTLC resolveTime */
        resolveTime?: (Long|null);
    ...
    class InvoiceHTLC implements IInvoiceHTLC {
        ...
        /** InvoiceHTLC acceptTime. */
        public acceptTime: Long;

        /** InvoiceHTLC resolveTime. */
        public resolveTime: Long;
    ...
    interface IListInvoiceRequest {
        ...
        indexOffset?: (Long|null);

        /** ListInvoiceRequest numMaxInvoices */
        numMaxInvoices?: (Long|null);
    ...
    class ListInvoiceRequest implements IListInvoiceRequest {
        ...
        /** ListInvoiceRequest indexOffset. */
        public indexOffset: Long;

        /** ListInvoiceRequest numMaxInvoices. */
        public numMaxInvoices: Long;
    ...
    interface IListInvoiceResponse {
        ...
        lastIndexOffset?: (Long|null);

        /** ListInvoiceResponse firstIndexOffset */
        firstIndexOffset?: (Long|null);
    }
    ...
    class ListInvoiceResponse implements IListInvoiceResponse {
        ...
        /** ListInvoiceResponse lastIndexOffset. */
        public lastIndexOffset: Long;

        /** ListInvoiceResponse firstIndexOffset. */
        public firstIndexOffset: Long;
    ...
    interface IPayment {
        ...
        creationTimeNs?: (Long|null);

        /** Payment htlcs */
        htlcs?: (lnrpc.IHTLCAttempt[]|null);

        /** Payment paymentIndex */
        paymentIndex?: (Long|null);
    ...
    class Payment implements IPayment {
        ...
        /** Payment creationTimeNs. */
        public creationTimeNs: Long;

        /** Payment htlcs. */
        public htlcs: lnrpc.IHTLCAttempt[];

        /** Payment paymentIndex. */
        public paymentIndex: Long;
    ...
    interface IHTLCAttempt {
        ...
        attemptTimeNs?: (Long|null);

        /** HTLCAttempt resolveTimeNs */
        resolveTimeNs?: (Long|null);
    ...
    class HTLCAttempt implements IHTLCAttempt {
        ...
        /** HTLCAttempt attemptTimeNs. */
        public attemptTimeNs: Long;

        /** HTLCAttempt resolveTimeNs. */
        public resolveTimeNs: Long;
    ...
    class ChannelFeeReport implements IChannelFeeReport {
        ...
        /** ChannelFeeReport baseFeeMsat. */
        public baseFeeMsat: Long;

        /** ChannelFeeReport feePerMil. */
        public feePerMil: Long;
    ...
    interface IFeeReportResponse {
        ...
        weekFeeSum?: (Long|null);

        /** FeeReportResponse monthFeeSum */
        monthFeeSum?: (Long|null);
    }
    ...
    class FeeReportResponse implements IFeeReportResponse {
        ...
        /** FeeReportResponse dayFeeSum. */
        public dayFeeSum: Long;

        /** FeeReportResponse weekFeeSum. */
        public weekFeeSum: Long;

        /** FeeReportResponse monthFeeSum. */
        public monthFeeSum: Long;
    ...
    class ForwardingEvent implements IForwardingEvent {
        ...
        /** ForwardingEvent chanIdIn. */
        public chanIdIn: Long;

        /** ForwardingEvent chanIdOut. */
        public chanIdOut: Long;
        ...
        /** ForwardingEvent amtInMsat. */
        public amtInMsat: Long;

        /** ForwardingEvent amtOutMsat. */
        public amtOutMsat: Long;
